...
def createDB(thong, name, path):
    ...
    data = {
        ...
        "meta": {
            ...
            "tables": [
                {"enable": True, "col_d": col_d[0]},
                {"enable": True, "col_d": col_d[1]},
                {"enable": False, "col_d": col_d[2]},
                {"enable": False, "col_d": col_d[3]},
                {"enable": False, "col_d": col_d[4]},
                {"enable": False, "col_d": col_d[5]},
                {"enable": False, "col_d": col_d[6]},
                {"enable": False, "col_d": col_d[7]},
                {"enable": False, "col_d": col_d[8]},
                {"enable": False, "col_d": col_d[9]},
            ],
            "number": 0,
            "maxRow": 100,
            "buttons": [True, False],
